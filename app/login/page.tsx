        ...
        <div className="relative h-full w-full">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-background/80 to-background/20 p-10 flex flex-col justify-end">
            <blockquote className="space-y-2">
              <p className="text-lg">
                "SmartBudget helped me save enough for my semester abroad. The visual goals and tips made budgeting
                actually enjoyable!"
              </p>
              <footer className="text-sm">Sofia M., Finance Student</footer>
            </blockquote>
          </div>
        </div>
      </div>
