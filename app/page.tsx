            ...
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 xl:grid-cols-2">
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    Take control of your finances with SmartBudget. Track expenses, set savings goals, and make informed
                    financial decisions.
                  </p>
                </div>
              ...
              <div className="flex items-center justify-center">
                <img
                  ...
                  alt="SmartBudget Dashboard Preview"
                  width={550}
                  height={550}
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Everything you need to manage your finances as a student
                </p>
              </div>
            </div>
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 md:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-6">
                ...
                <p className="text-center text-muted-foreground">
                  Set and track progress toward your financial goals with visual indicators.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-6">
                <div className="rounded-full bg-primary p-2 text-primary-foreground">
              ...
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-6">
                <div className="rounded-full bg-primary p-2 text-primary-foreground">
                  ...
                  >
                    ...
                    <path d="M6 12h2"></path>
                    <path d="M16 8l1.5-1.5"></path>
                    <path d="M6.5 17.5 8 16"></path>
                    <path d="M16 16l1.5 1.5"></path>
                    <path d="M6.5 6.5 8 8"></path>
                  </svg>
                </div>
                <h3 className="text-xl font-bold">Financial Tips</h3>
                <p className="text-center text-muted-foreground">
                  Get personalized advice to help you make better financial decisions.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-6">
                <div className="rounded-full bg-primary p-2 text-primary-foreground">
                ...
                <p className="text-center text-muted-foreground">
                  Personalize your experience with theme options and accessibility features.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-6">
                <div className="rounded-full bg-primary p-2 text-primary-foreground">
                ...
                <p className="text-center text-muted-foreground">
                  Designed for everyone with WCAG 2.0 compliance and inclusive features.
                </p>
              </div>
            </div>
          </div>
